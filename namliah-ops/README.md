...
منصة عربية (RTL) لإدارة العمليات اليومية لفرع نملية:

- **استقبال آلي** لبيانات اليومية وتفاصيل المبيعات من وورك فلو خارجي (n8n / Make) عبر Webhook مؤمّن.
- **صفحة مدير التشغيل**: مراجعة مبيعات اليوم، إضافة ملاحظات تشغيلية، ثم **اعتماد التقرير ونشره** وتصديره PDF.
...
X-Webhook-Secret: <WEBHOOK_SECRET من ملف .env>
```
...
2. ضع رابط صفحة الفرع في قوقل ماب في `GOOGLE_MAPS_URL`.
